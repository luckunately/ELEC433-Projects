...
% Should we talk about other hardware acceleration applications? Like distance wireless communication, data centers, etc.
% I have a good application for firewall overpassing, but I don't know if it is relevant. Let me know if you want me to include it.

% \begin{frame}{Other applications}
%   Hardware acceleration of ECC saves power and time in data centers and other applications.
% \end{frame}
\end{document}
